...
export const ProgramDetails = () =>
{
  ...
  return (
      ...
      <Box sx={{margin:'3%'}}>
        ...
        <Typography>{ `${ formatHour(new Date(event?.date_begin ? event?.date_begin:''  ))} a ${ formatHour(new Date(event?.date_end ? event?.date_begin:''   ))} ${  formatTime( event?.duration) } ` }</Typography>
